...
const curriculo = "/assets/PABLO_MOREIRA_pt_resume.pdf";
const resume = "/assets/PABLO_MOREIRA_en_resume.pdf";
      ...
      <div className="w-screen h-auto flex-1 flex flex-col justify-between items-center pb-6 relative">
        <div className="flex h-auto mt-10 items-center justify-between w-full px-14 max-[1000px]:flex-wrap max-[1000px]:px-6 ">
          <div className="flex flex-col gap-14 w-full ">
            ...
            <div className="flex flex-col gap-3 max-w-[760px] ">
              <BoxReveal boxColor={"#262626"} duration={0.5}>
                <p className="inter text-lg font-extralight">
              ...
              <div className="z-10 flex max-[480px]:flex-wrap mt-16 items-center justify-start padding-button">
                <BoxReveal width="100%" boxColor={"#262626"} duration={0.5}>
                  <Button
                    ...
                    initialText={
                      <span className="gap-3 group inline-flex items-center">
                        Currículo
                        <svg
        ...
        <div className="flex max-[650px]:flex-col-reverse max-[650px]:items-end max-[1000px]:flex-wrap-reverse max-[608px]:gap-16 max-[608px]:mt-14 gap-8 place-items-end justify-between bottom-8 w-screen px-8">
          <div className="flex gap-8">
            ...
            <a
              className="inter capitalize text-base cursor-pointer"
              href="https://www.instagram.com/pablocmoreira/"
              target="_blank"
            >
              <BlurIn
                word="Instagram"
